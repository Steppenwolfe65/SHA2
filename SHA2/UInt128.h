...
namespace SHA2
{
	...
	public:
		...
		/// <summary>
		/// Initialize with 2 * 64bit unsigned integers
		/// </summary>
		///
		/// <param name="X0">ulong 0</param>
		/// <param name="X1">ulong 1</param>
		UInt128(ulong X0, ulong X1)
		{
			Register = _mm_set_epi64x(X0, X1);
		}
		...
		/// <summary>
		/// Load with 2 * 64bit unsigned integers in Big Endian format
		/// </summary>
		///
		/// <param name="X0">ulong 0</param>
		/// <param name="X1">ulong 1</param>
		void LoadBE(ulong X0, ulong X1)
		{
			Swap().LoadLE(X0, X1);
		}
		...
		/// <summary>
		/// Load with 2 * 64bit unsigned integers in Little Endian format
		/// </summary>
		///
		/// <param name="X0">ulong 0</param>
		/// <param name="X1">ulong 1</param>
		void LoadLE(ulong X0, ulong X1)
		{
			Register = _mm_set_epi64x(X0, X1);
		}
		...
		static inline UInt128 ShuffleLoadBE32(const std::vector<byte> &Input, size_t Offset, size_t Shift)
		{
			return UInt128(
				...
				((uint)Input[Offset + 3]),
				((uint)Input[Offset + Shift] << 24) | 
				((uint)Input[Offset + 1 + Shift] << 16) | 
				((uint)Input[Offset + 2 + Shift] << 8) | 
				((uint)Input[Offset + 3 + Shift]),
				((uint)Input[Offset + Shift * 2] << 24) | 
				((uint)Input[Offset + 1 + Shift * 2] << 16) | 
				((uint)Input[Offset + 2 + Shift * 2] << 8) | 
				((uint)Input[Offset + 3 + Shift * 2]),
				((uint)Input[Offset + Shift * 3] << 24) | 
				((uint)Input[Offset + 1 + Shift * 3] << 16) | 
				((uint)Input[Offset + 2 + Shift * 3] << 8) | 
				((uint)Input[Offset + 3 + Shift * 3]));
		}

		/// <summary>
		/// Load a Uint128 in Big Endian format using 64bit uints staggered at multiples of the shift factor
		/// </summary>
		///
		/// <param name="Input">The input byte array</param>
		/// <param name="Offset">The starting offset within the input array</param>
		...
		/// 
		/// <returns>A populated UInt128</returns>
		static inline UInt128 ShuffleLoadBE64(const std::vector<byte> &Input, size_t Offset, size_t Shift)
		{
			return UInt128(
		...
		/// <summary>
		/// Load a Uint128 in native format using a 32bit uint array staggered at multiples of the shift factor
		/// </summary>
		///
		...
		static inline UInt128 ShuffleLoadLE(const std::vector<byte> &Input, size_t Offset, size_t Shift)
		{
			return UInt128(
				...
				((uint)Input[Offset + Shift]) |
				((uint)Input[Offset + 1 + Shift] << 8) |
				((uint)Input[Offset + 2 + Shift] << 16) |
				((uint)Input[Offset + 3 + Shift] << 24),
				((uint)Input[Offset + Shift * 2]) |
				((uint)Input[Offset + 1 + Shift * 2] << 8) |
				((uint)Input[Offset + 2 + Shift * 2] << 16) |
				((uint)Input[Offset + 3 + Shift * 2] << 24),
				((uint)Input[Offset + Shift * 3]) |
				((uint)Input[Offset + 1 + Shift * 3] << 8) |
				((uint)Input[Offset + 2 + Shift * 3] << 16) |
				((uint)Input[Offset + 3 + Shift * 3] << 24));
		}
		...
		/// </summary>
		/// 		
		/// <param name="R">The UInt128 to process</param>
		/// 
		/// <returns>The byte swapped UInt128</returns>
		static inline UInt128 Swap(UInt128 &R)
		{
			__m128i T = R.Register;
		...
		{
			memcpy(&Output[OutOffset], &Register.m128i_u8[0], 16);
		}
		...
		{
			memcpy(&Output[OutOffset], &Register.m128i_u16[0], 16);
		}
		...
		{
			memcpy(&Output[OutOffset], &Register.m128i_u32[0], 16);
		}
		...
		{
			memcpy(&Output[OutOffset], &Register.m128i_u64[0], 16);
		}
