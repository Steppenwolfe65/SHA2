...
namespace SHA2
{
	...
	private:
		...
		template <typename T>
		static inline void SHA512Round(T &A, T &B, T &C, T &D, T &E, T &F, T &G, T &H, T &M, ulong P)
		{
		...
		template <typename T, typename R>
		static inline void ShuffleStore(R &W, std::vector<T> &Output, size_t OutOffset, size_t Index)
		{
			std::vector<ulong> tmp(W.Length() / sizeof(ulong));
			W.StoreLE(tmp, 0);

			for (size_t i = 0; i < tmp.size(); ++i)
				Output[OutOffset + i].H[Index] = tmp[i];
		}
	...
	public:
		...
		static inline void Compress512(const std::vector<byte> &Input, size_t InOffset, std::vector<T> &Output, size_t OutOffset)
		{
			...
			ULong256 H0 = A, H1 = B, H2 = C, H3 = D, H4 = E, H5 = F, H6 = G, H7 = H;
			ULong256 W0, W1, W2, W3, W4, W5, W6, W7, W8, W9, W10, W11, W12, W13, W14, W15, R0, R1;

			W0 = ULong256::ShuffleLoadBE(Input, InOffset, 128);
			SHA512Round(A, B, C, D, E, F, G, H, W0, 0x428a2f98d728ae22);
			W1 = ULong256::ShuffleLoadBE(Input, InOffset + 8, 128);
			SHA512Round(H, A, B, C, D, E, F, G, W1, 0x7137449123ef65cd);
			W2 = ULong256::ShuffleLoadBE(Input, InOffset + 16, 128);
			SHA512Round(G, H, A, B, C, D, E, F, W2, 0xb5c0fbcfec4d3b2f);
			W3 = ULong256::ShuffleLoadBE(Input, InOffset + 24, 128);
			SHA512Round(F, G, H, A, B, C, D, E, W3, 0xe9b5dba58189dbbc);
			W4 = ULong256::ShuffleLoadBE(Input, InOffset + 32, 128);
			SHA512Round(E, F, G, H, A, B, C, D, W4, 0x3956c25bf348b538);
			W5 = ULong256::ShuffleLoadBE(Input, InOffset + 40, 128);
			SHA512Round(D, E, F, G, H, A, B, C, W5, 0x59f111f1b605d019);
			W6 = ULong256::ShuffleLoadBE(Input, InOffset + 48, 128);
			SHA512Round(C, D, E, F, G, H, A, B, W6, 0x923f82a4af194f9b);
			W7 = ULong256::ShuffleLoadBE(Input, InOffset + 56, 128);
			SHA512Round(B, C, D, E, F, G, H, A, W7, 0xab1c5ed5da6d8118);
			W8 = ULong256::ShuffleLoadBE(Input, InOffset + 64, 128);
			SHA512Round(A, B, C, D, E, F, G, H, W8, 0xd807aa98a3030242);
			W9 = ULong256::ShuffleLoadBE(Input, InOffset + 72, 128);
			SHA512Round(H, A, B, C, D, E, F, G, W9, 0x12835b0145706fbe);
			W10 = ULong256::ShuffleLoadBE(Input, InOffset + 80, 128);
			SHA512Round(G, H, A, B, C, D, E, F, W10, 0x243185be4ee4b28c);
			W11 = ULong256::ShuffleLoadBE(Input, InOffset + 88, 128);
			SHA512Round(F, G, H, A, B, C, D, E, W11, 0x550c7dc3d5ffb4e2);
			W12 = ULong256::ShuffleLoadBE(Input, InOffset + 96, 128);
			SHA512Round(E, F, G, H, A, B, C, D, W12, 0x72be5d74f27b896f);
			W13 = ULong256::ShuffleLoadBE(Input, InOffset + 104, 128);
			SHA512Round(D, E, F, G, H, A, B, C, W13, 0x80deb1fe3b1696b1);
			W14 = ULong256::ShuffleLoadBE(Input, InOffset + 112, 128);
			SHA512Round(C, D, E, F, G, H, A, B, W14, 0x9bdc06a725c71235);
			W15 = ULong256::ShuffleLoadBE(Input, InOffset + 120, 128);
			SHA512Round(B, C, D, E, F, G, H, A, W15, 0xc19bf174cf692694);
			...
			ShuffleStore(A, Output, OutOffset, 0);
			ShuffleStore(B, Output, OutOffset, 1);
			ShuffleStore(C, Output, OutOffset, 2);
			ShuffleStore(D, Output, OutOffset, 3);
			ShuffleStore(E, Output, OutOffset, 4);
			ShuffleStore(F, Output, OutOffset, 5);
			ShuffleStore(G, Output, OutOffset, 6);
			ShuffleStore(H, Output, OutOffset, 7);

			Output[OutOffset].Increase(BLOCK_SIZE);
			Output[OutOffset + 1].Increase(BLOCK_SIZE);
			Output[OutOffset + 2].Increase(BLOCK_SIZE);
			Output[OutOffset + 3].Increase(BLOCK_SIZE);

#else
			Compress128(Input, Offset, State);
			Compress128(Input, Offset + 64, State);
			Compress128(Input, Offset + 128, State);
			Compress128(Input, Offset + 192, State);
			Compress128(Input, Offset + 256, State);
			Compress128(Input, Offset + 320, State);
			Compress128(Input, Offset + 384, State);
			Compress128(Input, Offset + 448, State);
#endif
		}
	};
}